...
To compile both programs using the intel compilers, type ``make intel" into 
the main directory. To compile fortran using ifort, type ``make ifort". To 
compile C using icc, type "make icc". 
